  ...
  const burgerMenu = {
    init(rootSel, p = {}) {
      ...
      const onLink = (e) => {
        ...
        // FIX: закрываем без event, чтобы не сработал preventDefault и ссылка ушла
        close();
      };
      ...
      // links
      // FIX: panel может быть shape (не контейнер ссылок), поэтому ловим клики на всём меню в capture
